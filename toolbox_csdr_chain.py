...
from csdr.module.toolbox import Rtl433Module, Rtl4332Module, MultimonModule, RedseaModule, CwSkimmerModule, LameModule
...
class LoRaDemodulator(ServiceDemodulator, DialFrequencyReceiver):
    def __init__(self, sampleRate: int = 250000, service: bool = False):
        ...
        workers = [
            Rtl4332Module(self.sampleRate, jsonOutput = False),
            self.parser,
        ]
        # Connect all the workers
        super().__init__(workers)
