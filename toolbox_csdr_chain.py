...
from csdr.module.toolbox import Rtl433Module, LoRaModule, MultimonModule, RedseaModule, CwSkimmerModule, LameModule
...
class LoRaDemodulator(ServiceDemodulator, DialFrequencyReceiver):
    def __init__(self, sampleRate: int = 250000, service: bool = False):
        ...
        workers = [
            LoRaModule(self.sampleRate, jsonOutput = False),
            self.parser,
        ]
        # Connect all the workers
        super().__init__(workers)
